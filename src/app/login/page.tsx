...
import { LogIn, Mail, Lock, Eye, EyeOff, Sparkles, Loader2, AlertCircle } from 'lucide-react';
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-gray-100">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              {isLogin ? 'Entre para continuar suas compras' : 'Cadastre-se e ganhe R$ 50 de cashback'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  minLength={6}
                  className="w-full pl-11 pr-11 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all"
                />
                <button
                  type="button"
            ...
            {isLogin && (
              <div className="flex justify-end">
                <Link href="/recover-password" className="text-sm text-purple-600 hover:text-purple-700 font-semibold">
                  Esqueceu a senha?
                </Link>
              </div>
            )}
          ...
          <div className="space-y-3">
            <button 
              type="button"
              className="w-full px-6 py-3 bg-white border-2 border-gray-200 hover:border-purple-300 text-gray-700 font-semibold rounded-xl transition-all duration-300 flex items-center justify-center gap-2"
            >
